function opts = loadBenthamICFHR14(path)

% e.g. path = '/home/george/Desktop/WS_Journal_Experiments/Bentham/';

opts.dataset = 'BenthamICFHR14';
...
if ~exist(opts.datasetPath,'dir')
    ...
    wpath = [path, 'TRACK_I_Bentham_Dataset/'];
    ...
    for i = 1:numel(fnames)    
        ...
        I_rgb4 = imread([wpath name '.tif']);
        I = rgb2gray(I_rgb4(:,:,1:3));
...
if ~exist(opts.queriesPath,'dir')
    ...
    qpath = [path, '/ICFHR2014_TRACK_I_Bentham_Queries/images/'];
    ...
    gt_xml = 'TRACK_I_Bentham_ICFHR2014.RelevanceJudgements.xml';
    ...
    for i = 1:numel(s)
        ...
        str_id = regexp(tmp_text,'(?<=document="[^\w]*)(\w*)_(\w*)','match');
